...
parser.add_argument("eid", help='art eid, e.g. \'2-s2.0-84891048418\'')
parser.add_argument("num", help='Number of items to get in a single query, 25, 100 or 200')
args = parser.parse_args()

# refeid search finds citations for a given eid! <--- unsupported by elsevier!
q = 'REFEID({args.eid})'.format(args=args)
